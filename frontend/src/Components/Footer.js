        ...
        <div className="md:flex md:justify-between">
          ...
          <div className=" ">
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="mailto:support@rentify.com" className="hover:underline">
                    support@rentify.com
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="https://github.com/Shekarbanda" rel="noreferrer" target="_blank" className="hover:underline ">
                    Github
                  </a>
                </li>
                <li>
                  <a href="https://discord.com/" rel="noreferrer" target="_blank" className="hover:underline">
                    Discord
                  </a>
                </li>
              </ul>
