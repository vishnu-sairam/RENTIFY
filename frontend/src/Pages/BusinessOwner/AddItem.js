    ...
    <>
      ...
      <div className=" max-w-[1400px]  mx-auto bg-white flex pt-[50px] lg:pt-[72px] shadow-lg border border-[rgba(5,10,27,0.2)]">
        ...
        >
          ...
          <button
            className={`w-full flex items-center p-2 transition rounded addItem bg-blue-200 hover:bg-blue-200`}
        ...
        {/* Content Area */}
        <div className="flex-1 min-h-[65vh] lg:min-h-[78.5vh] md:min-h-[80.5vh] flex flex-col  mb-7 bg-[rgba(231,235,240,0.29)]">
          <PostItem />
        </div>
      </div>
      <Footer />
